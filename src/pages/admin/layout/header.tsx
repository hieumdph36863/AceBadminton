            ...
            <ul className="ml-auto flex items-center">
                ...
                <div className="w-full md:w-72">
                    <div className="relative h-9 w-full min-w-[200px]">
                        <div className="absolute grid w-5 h-3 top-2/4 right-3 -translate-y-1/4 place-items-center text-blue-gray-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" aria-hidden="true" className="w-5 h-5">
                        ...
                        <form id="searchForm" method="GET" action="#">
                            <input id="search" name="keyword"
                                className="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2 !pr-9 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                placeholder="Search" />
                        </form>
                    </div>
                </div>
                            ...
                            <form method="POST" action="">
                                <a
                                    ...
                                    onClick={(event) => {
                                        ...
                                        const form = event.currentTarget.closest('form'); // Tìm form gần nhất
                                        if (form) {
                                            form.submit(); // Gửi form nếu tìm thấy
                                        }
                                    }}
                                >
                                    Log Out
